...
public class MessengerCallbackHandler {
    ...
    public MessengerCallbackHandler(EventHandlers eventHandlers, Environment environment) {
        ...
        this.receiveClient = MessengerPlatform.newReceiveClientBuilder(appSecret, verifyToken)
                                              .onTextMessageEvent(eventHandlers.getTextMessageEventHandler())
                                              .onMessageDeliveredEvent(eventHandlers.getMessageDeliveredEventHandler())
                                              .onMessageReadEvent(eventHandlers.getMessageReadEventHandler())
                                              .fallbackEventHandler(eventHandlers.getFallbackEventHandler())
                                              .build();
    }
